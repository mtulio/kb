'
'  Name: MTAD_CreateEstrutura.vbs
'  Copyright: DOMAD MTulio ENG
'  Author: Marco Túlio Rodrigues Braga
'  Date: 29/10/11 02:40
'  Description: Este script foi criado para criação da estrutura organizacional implementada no trabalho de Conclusão de Curso. Este script pode ser utilizado e distribuido de acordo com a necessidade.
'
