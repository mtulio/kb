...
//tem como parametro um objeto da classe controle
//PQ? pq a unica comunicacao com a classe persistencia, aonde se encontra a agenda, e a passagem pela classe controle
...
{// inicio metodo
	...
	while(opcao){// inicio while
		...
		cout<<endl<<"| 7 - LISTAGEM POR NOME |";
		cout<<endl<<"| 8 - ORDENAR AGENDA    |";
		cout<<endl<<"| 9 - ORDENAR E GRAVAR  |";
        cout<<endl<<"| 0 - SAIR              |";
		...
		switch(opcao){// inicio switch
			...
			case 4:{// inicio case 4 - CONSULTAR
                    ...
                    cout<<endl<<" CONSULTAR";
                    cout<<endl<<"NOME: ";
					cin.get();//pausa a tela para permitir a laitura com o getline
					getline(cin,nome);
			...
			case 6:{//inicio do case 6 - LISTAGEM POR LETRA
					...
					Iterator *iterator = ctrl.listagemLetra(letra);
					...
					system("cls");
					cout<<"\t**_SISTEMA_DA_AGENDA_**"<<endl;
					cout<<endl<<" LISTAGEM POR LETRA"<<endl;
					cout<<superior<<endl;
                    cout<<"______NOME_________TELEFONE______________EMAIL__________"<<lateral<<endl;
           ...
           case 7:{ //LISTAGEM POR NOME
                    ...
                    cin.get();
                    //nomeInfo=cin.get();//recebe o nome digitado no teclado, mas eh usando apenas para char
                    getline(cin,nomeInfo);//le os dados digitados no teclado e armazenam na var nomeInfo
                    Iterator* iterator = ctrl.listagemNome(nomeInfo);
                    //enviara uma chamda para o metodo da classe controle que retornara um objeto 
                    //da classe iterator q sera armazenado no objeto iterator
                    if (iterator->estaVazio()){//verifica se a agenda dentro do iterador 
					                           //está vazia , neste caso vai ser pq n 
                                               //encontrara nenhum nome com a letra desejada
                       cout<<" NOME DESEJADO NAO ENCONTRADO" << endl;
                ...
                case 8:{//inicio case 8  -  ORGANIZANDO POR ORDEM ALFABETICA      
                    cout<<"Tem certeza que deseja executar a operacao:\n \"ORDENAR EM ORDEM ALFABETICA\"";
                    cout<<endl<<endl<<"Confirma Alteracao [s/n]:  ";
					char resp;
					cin.ignore();
                    resp=cin.get();
                    ...
                    if(resp != 's' && resp!='S'){
                            cout<<endl<<endl<<"->OPERACAO CANCELADA\n<ENTER> PARA CONTINUAR";
                            cin.get();
                            cin.get();
                            break;
                    }
                    Iterator *iterator = ctrl.listagemOrdenarAgenda();//chamando o metodo listagem geral q retorna um objeto da classe persistencia
				   	if (iterator->estaVazio()){ //verifica se a agenda que está no iterador
                                                   //está vazia.
                       cin.ignore();// ignora tudo o que foi armazenado no buffer do último cin.                    
                       cout<<" Agenda Vazia" << endl;
                    ...
                    system("cls");
					cout<<"\t**_SISTEMA_DA_AGENDA_**"<<endl;
                    cout<<endl<<"  ORGANIZAR AGENDA"<<endl;
					cout<<superior<<endl;
                    cout<<"______NOME_________TELEFONE______________EMAIL__________"<<lateral<<endl;
            ...
            case 9:{//case 9 - para listagem e gravar o arquivo em disco
                 
                    cout<<"Operacao:\"ORDENAR EM ORDEM ALFABETICA E GRAVAR EM DISCO\"";
                    cout<<endl<<endl<<"Confirma Operacao [s/n]:  ";
                    cin.ignore();
                    char resp;
                    resp=cin.get();
                    if(resp != 's' && resp!= 'S' || resp=='n' && resp=='N') resp='n';
                    if(resp=='s' || resp=='S'){
                              if(ctrl.ordenarEGravar()){
                    ...
                    else {     cout<<endl<<endl<<"->OPERACAO CANCELADA\n<ENTER> PARA CONTINUAR";
                            cin.get();
                            cin.get();
                    }
                    break;                                                   
