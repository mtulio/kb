...
//Convertendo String para int... subtrai-se 48
	for(int i=0; i<tamStr; i++)
	{
		...
		if(estadoAtual=="q0") estadoAtual=ler_q0(vl_lido);
										...
										else if(estadoAtual=="q8") estadoAtual=ler_q8(vl_lido);
	}//fim for
...
//************************************
string Div9::ler_q0(int vl_lido)
{
	switch(vl_lido)
	{//switch
		...
		case 8:{ return "q8"; break; }
		case 9:{ return "q0"; break; }
	}//fim switch
}//fim ler q0
//************************************
string Div9::ler_q1(int vl_lido)
{
//cout<<"\n\tENTREI NO MTD ler_q1 com valor: "<<vl_lido<<endl;
	...
	{//switch
		...
		case 6:{ return "q7"; break; }
		case 7:{ return "q8"; break; }
		case 8:{ return "q0"; break; }
		case 9:{ return "q1"; break; }
	}//fim switch
}//fim ler q1
/********************************************************************/
string Div9::ler_q2(int vl_lido)
{
...
/********************************************************************/
string Div9::ler_q3(int vl_lido)
{
//cout<<"\n\tENTREI NO MTD ler_q3 com valor: "<<vl_lido<<endl;
	...
	{//switch
		...
		case 4:{ return "q7"; break; }
		case 5:{ return "q8"; break; }
...
/********************************************************************/
string Div9::ler_q4(int vl_lido)
{
...
/********************************************************************/
string Div9::ler_q5(int vl_lido)
{
//cout<<"\n\tENTREI NO MTD ler_q5 com valor: "<<vl_lido<<endl<<endl;
	...
	{//switch
		...
		case 2:{ return "q7"; break; }
		case 3:{ return "q8"; break; }
...
/********************************************************************/
string Div9::ler_q6(int vl_lido)
{
...
/********************************************************************/
string Div9::ler_q7(int vl_lido)
{
//cout<<"\n\tENTREI NO MTD ler_q6 com valor: "<<vl_lido<<endl<<endl;
	switch(vl_lido)
	{//switch
		case 0:{ return "q7"; break; }
		case 1:{ return "q8"; break; }
...
string Div9::ler_q8(int vl_lido)
{
//cout<<"\n\tENTREI NO MTD ler_q6 com valor: "<<vl_lido<<endl<<endl;
	switch(vl_lido)
	{//switch
		case 0:{ return "q8"; break; }
		...
		case 8:{ return "q7"; break; }
		case 9:{ return "q8"; break; }
	}//fim switch
}//fim ler q7
/********************************************************************/
