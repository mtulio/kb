...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// 
			this->ferramentasToolStripMenuItem->DropDownItems->AddRange(gcnew cli::array< System::Windows::Forms::ToolStripItem^  >(1) {this->compilarToolStripMenuItem});
			...
			this->compilarToolStripMenuItem->Size = System::Drawing::Size(163, 22);
...
#pragma endregion
//MessageBox::Show("Ação de compilar\r\n"									
									//, "Compilando msg box", MessageBoxButtons::OK, MessageBoxIcon::Information);
	
private: System::Void compilarToolStripMenuItem_Click(System::Object^  sender, System::EventArgs^  e) {
				 //Compilador AQUI
	string msgRetorno = "";
	Automato automato(arquivo); //Verificar o nome da variavel global arquivo
	msgRetorno = automato.iniciarAutomato();
	if(automato->iniciarAutomato() != ("-1")) 
if(msgRetorno!= ("-1")) richTextBox2->Text = msgRetorno; //imprimir na segunda caixa de texto
			
}//fim metodo compilarToolStripMenuItem_Click
