...
*
* Detalhes: Classe Automato.h que tem a finalidade de percorrer um automato
* definido no trabalho. Essa classe faz a analise lexica, sintatica e semantica 
* de uma arquivo que contem os comandos em portugol. Também no momento da execução 
* é feita uma conversão do arquivo fonte e o gerando uma equivalente em C.
* Esta classe depende da Persistencia.h que manipula o arquivo.
*/
